...
// Textures
const mapTexture = textureLoader.load(staticURL + '/models/LeePerrySmith/color.jpg')
mapTexture.encoding = THREE.sRGBEncoding

const normalTexture = textureLoader.load(staticURL + '/models/LeePerrySmith/normal.jpg')
 ...
 */
gltfLoader.load(
    staticURL + '/models/LeePerrySmith/LeePerrySmith.glb',
    (gltf) => {
        // Model
