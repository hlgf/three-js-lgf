 ...
 */
gltfLoader.load(
    staticURL + '/models/DamagedHelmet/glTF/DamagedHelmet.gltf',
    (gltf) => {
...
displacementPass.material.uniforms.uNormalMap.value = textureLoader.load(staticURL + '/textures/interfaceNormalMap.png')
