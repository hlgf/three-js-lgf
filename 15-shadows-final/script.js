...
const bakedShadow = textureLoader.load(staticURL + '/textures/bakedShadow.jpg')
const simpleShadow = textureLoader.load(staticURL + '/textures/simpleShadow.jpg')
